...
GC9A01A_Config eyeInfo[] = {
    ...
    {0,  2, 26, 27, 3, 2, false, true, true}, // Left display (L1, R1)
    {10, 9, 11, 13, 8, 1, true, true, true}, // Right display (L2, L3, R2, R3)
};
#elif defined USE_ST7789
